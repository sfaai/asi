...
{
    [MetadataType(typeof(CSDNDMetadata))]
    public partial class CSDND
    {
        ...
        public int refcnt
        {
            get
            {
                ...
                {
                    _CSTRANM = db.CSTRANMs.Find("CSDN", this.TRNO, this.TRID);
        ...
        public Uri Link
        {
            get
            {
                if ((this.TRNO != null) && (this.TRNO != string.Empty))
                {
                    ...
                    _CSTRAND = db.CSTRANDs.Where(x => x.DBTYPE == "CSDN" && x.DBNO == this.TRNO && x.DBID == this.TRID);
                    if (_CSTRAND != null) {
