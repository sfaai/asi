    ...
    public class AccountController : Controller
    {
                ...
                case SignInStatus.Success:
                    ...
                    if (staffrec != null)
                    {
                        ...
                        if (Descendent.Count() > 1)
                        {
                            ...
                            {
                                if (stafflist == string.Empty) { stafflist = "'" + item.STAFFCODE + "'"; }
                                else
                                {
                    ...
                    //}
                    if (returnUrl == null) { return RedirectToAction("Work","Home"); }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    // sync with legacy user account database
                    SAUSERM sAUSERM = db.SAUSERMs.Find(user.UserName);
                    if (sAUSERM == null)
                    {
                        sAUSERM = new SAUSERM();
                        sAUSERM.USERID = user.UserName;
                        sAUSERM.USERNAME = user.UserName;
                        sAUSERM.PW = "Bub'qig9"; //Default to Asi!sec0
                        sAUSERM.CRDATE = DateTime.Today;
                        sAUSERM.EXPDAYS = 0;
                        sAUSERM.LUDATE = sAUSERM.CRDATE;
                        sAUSERM.EXUSER = "N";
                        sAUSERM.MAXSESSION = 50;
                        sAUSERM.USERTYPE = "User";
                        sAUSERM.PWMINCHAR = 4;
                        sAUSERM.PWRECYCLE = 3;
                        sAUSERM.PWFAILLOCK = 3;
                        sAUSERM.USERLOCK = "N";
                        sAUSERM.STAMP = 0;
                        ...
                        SAUSERDG sAUSERDG = new SAUSERDG();
                        sAUSERDG.USERID = user.UserName;
                        sAUSERDG.GRPCODE = "CS-AS";
                        sAUSERDG.MODULECODE = "CS";
                        sAUSERDG.STAMP = 0;
                        db.SAUSERDGs.Add(sAUSERDG);
